/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 08d821a6fce5fd7d9612d6a63ab58f2d)
// Runtime types generated with workerd@1.20250924.0 2025-09-24 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "QualityAnalysisState";
	}
	interface Env {
		OPENAI_API_KEY: string;
		AI_GATEWAY_ACCOUNT_ID: string;
		AI_GATEWAY_ID: string;
		QUALITY_ANALYSIS_STATE: DurableObjectNamespace<import("./src/index").QualityAnalysisState>;
		AI: Ai;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "OPENAI_API_KEY" | "AI_GATEWAY_ACCOUNT_ID" | "AI_GATEWAY_ID">> {}
}
